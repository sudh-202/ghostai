...
- `PATCH /api/projects/[projectIdl]` , rename project
...
- default missing porject name to `Untitled Project`
- use the schema's existing ID strategy, do not add sequential Id's
